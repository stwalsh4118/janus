...
### New Files
- `web/hooks/useSpeechSynthesis.ts` - Custom hook for text-to-speech
- `web/components/SpeakingIndicator.tsx` - Visual feedback component

### Modified Files
- `web/app/page.tsx` - Add auto-play and stop functionality
- `web/lib/types.ts` - Add speech synthesis types
